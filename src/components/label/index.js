...
export default class Label extends PureComponent {
  ...
  componentWillReceiveProps(props) {
    ...
    if (focused ^ props.focused || active ^ props.active) {
      Animated.parallel([
        Animated.timing(inputTX, {
          toValue: this.inputTXState(props),
          duration,
          useNativeDriver: true
        }),
        Animated.timing(inputTY, {
          toValue: this.inputTYState(props),
          duration,
          useNativeDriver: true
        }),
        Animated.timing(inputScale, {
          toValue: this.inputScaleState(props),
          duration,
          useNativeDriver: true
        })
      ]).start();
  ...
  inputTYState(
    { focused, active, baseSize, fontSize, basePadding, activeFontSize } = this
      .props
  ) {
